...
public class FossilHRWatchAdapter extends FossilWatchAdapter {
    ...
    public void initialize() {
        ...
        // queueWrite(new PlayNotificationRequest("twitterrrr", "Twitterr", "tWITTER", this));queueWrite(new NotificationFilterPutRequest(
        //                new NotificationConfiguration[]{
        //                        new NotificationConfiguration((short) -1, (short) -1, "generic", "", false, PlayNotificationRequest.VibrationType.SINGLE_LONG, 0)
        //                },
        ...
        /*queueWrite(new ImagesSetRequest(
                new AssetImage[]{
                        AssetImageFactory.createAssetImage("0D58BD24", null, 0, 60, 1),
                        AssetImageFactory.createAssetImage("AD365776", null, 90, 60, 1),
                        AssetImageFactory.createAssetImage("C3F69363", null, 180, 60, 1),
                        AssetImageFactory.createAssetImage("7251C82B", null, 270, 60, 1),
                },
                this
        ));
*/
