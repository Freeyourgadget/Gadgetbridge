...
public class PebbleHealthSampleProviderV2 extends AbstractSampleProvider<PebbleHealthActivitySampleV2> {
    ...
    public PebbleHealthSampleProviderV2(GBDevice device, DaoSession session) {
        super(device, session);
    }

    @Override
    public List<PebbleHealthActivitySampleV2> getAllActivitySamples(int timestamp_from, int timestamp_to) {
        List<PebbleHealthActivitySampleV2> samples = super.getGBActivitySamples(timestamp_from, timestamp_to, ActivityKind.TYPE_ALL);
        ...
        for (PebbleHealthActivityOverlay overlay : overlayRecords) {
            for (PebbleHealthActivitySampleV2 sample : samples) {
    ...
    @Override
    public AbstractDao<PebbleHealthActivitySampleV2, ?> getSampleDao() {
        return getSession().getPebbleHealthActivitySampleV2Dao();
    }

    @Override
    protected Property getTimestampSampleProperty() {
        return PebbleHealthActivitySampleV2Dao.Properties.Timestamp;
    }
    ...
    protected Property getRawKindSampleProperty() {
        ...
        //return PebbleHealthActivitySampleV2Dao.Properties.RawKind;
    }

    @Override
    protected Property getDeviceIdentifierSampleProperty() {
        return PebbleHealthActivitySampleV2Dao.Properties.DeviceId;
    }

    @Override
    public PebbleHealthActivitySampleV2 createActivitySample() {
        return new PebbleHealthActivitySampleV2();
    }
