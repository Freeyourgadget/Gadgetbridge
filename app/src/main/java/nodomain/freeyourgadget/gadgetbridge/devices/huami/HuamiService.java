...
public class HuamiService {
    ...
    public static final byte[] COMMAND_DISABLE_BLUETOOTH_VISIBILITY = new byte[] { ENDPOINT_DISPLAY, 0x20, 0x0, 0x0 };
    public static final byte[] COMMAND_ENABLE_BLUETOOTH_VISIBILITY = new byte[] { ENDPOINT_DISPLAY, 0x20, 0x0, 0x1 };
    // public static final byte[] COMMAND_ENABLE_BLUETOOTH_VISIBILITY = new byte[] { ENDPOINT_DISPLAY, 0x01, 0x0, 0x0 };
    // public static final byte[] COMMAND_DISABLE_BLUETOOTH_VISIBILITY = new byte[] { ENDPOINT_DISPLAY, 0x01, 0x0, 0x1 };
